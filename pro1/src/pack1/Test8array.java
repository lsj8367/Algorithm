...
public class Test8array {
	...
	public static void main(String[] args) {
		// 배열 : 성격과 크기가 일치하는 복수개의 기억장소를 대표명 하나를 주고 첨자(index)로 기억장소를 구분
		// 장점 : 반복처리가 효과적 - for문과 함께함.
		int a; //simple variable
		int[] ar; // int ar[]와 같은 의미      array
		...
		int aa = 4, bb = 2 + 2 ;
		System.out.println("ar[4] : " + ar[aa] + " " + ar[bb] + " " + ar[2 * 2]); //첨자 변수
		...
		//향상된 for array 집단에서만 가능 어레이의 데이터가 소진될 때까지 반복
		for(int sbs:ar1) {
		...
		System.out.println(jum2[1].length);
